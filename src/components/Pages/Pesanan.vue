  ...
  <div class="home">
    <div>
      <div :style="styleBg" class="flex flex-wrap">
        ...
        <div class="w-8/12 animate-fade-left bg-white rounded-lg shadow-md mt-10">
          ...
          <div class="flex flex-wrap pb-3 pt-2 border-b-2" v-for="(items, i1) in dataPesanan" :key="i1">
            ...
            <div class="w-full">
              <div class="flex flex-wrap mb-2" v-for="(items2, i2) in items.jualdetil" :key="i2">
                ...
                <div class="w-10/12">
                  <div class="font-bold">{{ items2.nama_barang }} </div>
  ...
  methods: {
    ...
    handleResize: function () {
      if (window.innerWidth < 1000) {
        this.styleBg =
          "background: linear-gradient(to top,  #FFFFFF 50%, #057a55 50%)";
      } else {
        this.styleBg =
          "background: linear-gradient(to top,  #FFFFFF 75%, #057a55 25%)";
      }
    },
  },
};
